...
servers = {
  ...
  frodo:  {type: :javascript1, provision: %w{node} },
  bilbo:  {type: :javascript2, provision: %w{node} }
...
types = {
  ...
  javascript1: { box: :trusty64,  ip: "192.168.33.61" },
  javascript2: { box: :trusty64,  ip: "192.168.33.62" },
  javascript3: { box: :trusty64,  ip: "192.168.33.63" }
}
